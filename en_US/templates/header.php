...
<html lang="en">
	...
	<body>
		<header>
			<nav id="main-navbar" class="navbar navbar-expand-lg">
				...
				<form action="<?= $BASE_URL ?>search.php" method="GET" id="search-form" class="form-inline my-0 my-lg-0">
					...
					<input type="text" name="q" id="search" class="form-control" type="search" placeholder="Search for movies" aria-label="Search">
		...
		<?php
			...
			$changeLanguage_URL = str_replace("en_US", "pt_BR", $url_temp);
		?>
		<div class="container-language">
			<a href="<?= $changeLanguage_URL ?>">
				<img class="unselected" src="<?= $BASE_URL ?>../assets/flags/br_flag.png"></img>
			</a>
			<img src="<?= $BASE_URL ?>../assets/flags/us_flag.png"></img>
		</div>