<?php
	...
	if (empty($id)) {
		...
		if ($movie_category == "Ação") $movie_category = "Action";
		if ($movie_category == "Comédia") $movie_category = "Comedy";
		if ($movie_category == "Ficção científica") $movie_category = "Science fiction";
			...
			<?php if (!empty($userData) && !$userOwnsMovie && !$alreadyReviewed): ?>
				<div class="col-md-12" id="review-form-container">
					...
					<p class="page-description">
						Fill in the form with your rating and comment about the movie.
					</p>
					<form action="<?= $BASE_URL ?>review_process.php" id="review-form" method="POST">
						...
						<div class="form-group">
							...
							<textarea name="review" id="review" rows="4" class="form-control" placeholder="What did you think of the movie?"></textarea>
						</div>
